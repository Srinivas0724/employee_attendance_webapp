...
<head>
    ...
    <title>Mark Attendance - Manager Portal</title>
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="manager_mark_attendance.jsp" class="active"><span class="nav-icon">📍</span> My Attendance</a>
            </li>
            <li class="nav-item">
    ...
    <div class="main-content">
        <header class="topbar">
            ...
            <div class="user-profile">
                <span id="mgrName" class="user-email">Loading...</span>
        ...
        auth.onAuthStateChanged(user => {
            if (user) {
                db.collection("users").doc(user.email).get().then(doc => {
                    ...
                    // Only Managers and Admins allowed
                    if (role !== 'manager' && role !== 'admin') {
                        window.location.href = "index.html"; 
                    } else {
                        currentUser = user;
                        document.getElementById("mgrName").innerText = doc.data().fullName || user.email;
                        document.getElementById("loadingOverlay").style.display = "none";
                        loadLastStatus();
                        // Auto-start camera if desktop
